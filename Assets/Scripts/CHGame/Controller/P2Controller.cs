namespace CHGame
{
    ...
    public class P2Controller : MonoBehaviour, IController
    {
        ...
        [SerializeField]
        private List<Vector2>[] PlayerPointsOnPolygons;
        ...
        [SerializeField]
        public List<Polygon2D>[] PlayerPolygons;
        ...
        public void Start()
        {
          ...
          PlayerPointsOnPolygons = new List<Vector2>[2] {new List<Vector2>(), new List<Vector2>()};
        ...
        bool  DFS(int current_point, int start_point, ref int[] pre, ref bool[] visited,  ref bool[,] edgeUsed, int[,] edgeList, int[] edgeNum, ref List<int> cycle) {
          ...
          //  Debug.Log("current_point:" + current_point);
            ...
            if (visited[current_point]) {
                if (current_point != start_point) return false;
            ...
            for (int num = 0; num < edgeNum[current_point]; num++)
            {
                ...
                //TODO: check if the point lies on a existing polygon(maybe do this before DFS, remove from edgelist)
                {
                    pre[i] = current_point;
                    //visited[i] = true;
